<%@ page import="com.todo.todolist.LoginServlet" %>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title>ToDo Web App - Login</title>
                                ...
                                <div class="p-5">
                                    ...
                                    <form class="user" action="./LoginServlet" method="post">
                                        ...
                                        <div class="form-group">
                                            <input type="email" required class="form-control form-control-user" name="email" id="email" placeholder="Enter Email Address...">
                                        </div>
                                        <div class="form-group">
