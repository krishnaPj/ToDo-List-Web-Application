...
public class ExpiredUsersWorker implements Runnable {
	...
	public ExpiredUsersWorker(long sleepTime) { this.sleepTime = sleepTime; }

	@Override
	public void run() {
		while (keepRunning) {
			try { Thread.sleep(sleepTime); } catch (InterruptedException e) { LOGGER.warn("Interrupted", e); }
	...
	public synchronized void setKeepRunning(boolean keepRunning) { this.keepRunning = keepRunning; }
}
